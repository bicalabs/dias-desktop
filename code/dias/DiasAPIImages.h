...
class CDiasAPIImages : public CaImAPICollectionExt<CImage> {
...
// Operations
public:
	CImage& operator[] (uvar32_64 pos);
	CImage& operator[] (aImAPIRngType t) throw (CaImAPIException);
	...
	uvar32_64 Add (CImage& item);
	uvar32_64 Add (CaImAPIRange<CImage>& item);
	uvar32_64 Insert (uvar32_64 pos, CImage& item);
	uvar32_64 Insert (CString name, CImage& item);
	uvar32_64 Insert (uvar32_64 pos, CaImAPIRange<CImage>& item);
	uvar32_64 Insert (CString name, CaImAPIRange<CImage>& item);
